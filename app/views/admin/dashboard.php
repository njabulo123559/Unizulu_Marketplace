...
$select_profile->bind_param("i", $admin_id); // Bind the admin_id as an integer
   ...
   <div class="box-container">
      ...
      <div class="box">
         <?php
            ...
            $numbers_of_orders = $result_orders->num_rows;
         ?>
      ...
      <div class="box">
         <?php
            $select_messages = $conn->prepare("SELECT id FROM `messages`");
            $select_messages->execute();
            $result_messages = $select_messages->get_result();
            $numbers_of_messages = $result_messages->num_rows;
         ?>
